...
import { BoundingBox, ClusterOptions, Data, EdgeOptions, FitOptions, IdType, MoveToOptions, NetworkEvents, NodeOptions, OpenClusterOptions, Options, Position } from 'vis-network';
/**
...
export declare class VisNetworkService {
     ...
     * @memberOf NetworkService
     */
    create(visNetwork: string, container: HTMLElement, data: Data, options?: Options): void;
    /**
     ...
     * @memberOf NetworkService
     */
    on(visNetwork: string, eventName: NetworkEvents, preventDefault?: boolean): boolean;
    /**
     ...
     * @memberOf NetworkService
     */
    off(visNetwork: string, eventName: NetworkEvents): void;
    /**
     ...
     * @memberOf NetworkService
     */
    once(visNetwork: string, eventName: NetworkEvents): boolean;
    /**
     ...
     * @memberOf NetworkService
     */
    setData(visNetwork: string, data: Data): void;
    /**
     * Set the options.
     *
     * @param {string} visNetwork The network name/identifier.
     ...
     * @memberOf NetworkService
     */
    setOptions(visNetwork: string, options: Options): void;
    /**
     ...
     * @memberOf NetworkService
     */
    selectNodes(visNetwork: string, nodeIds: IdType[], highlightEdges?: boolean): void;
    /**
     ...
     * @memberOf NetworkService
     */
    setSelection(visNetwork: string, selection: {
        nodes: IdType[];
        edges: IdType[];
    }, options?: {
        unselectAll?: boolean;
     ...
     * @memberOf NetworkService
     */
    getSelectedNodes(visNetwork: string): IdType[];
    /**
     ...
     * @memberOf NetworkService
     */
    getSelectedEdges(visNetwork: string): IdType[];
    /**
     ...
     * @memberOf NetworkService
     */
    fit(visNetwork: string, options?: FitOptions): void;
    /**
     * Redraw the network.
     *
     * @param {string} visNetwork The network name/identifier.
     ...
     * @memberOf NetworkService
     */
    addNodeMode(visNetwork: string): void;
    /**
     ...
     * @memberOf NetworkService
     */
    cluster(visNetwork: string, options?: ClusterOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    clusterByConnection(visNetwork: string, nodeId: IdType, options?: ClusterOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    clusterByHubsize(visNetwork: string, hubsize?: number, options?: ClusterOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    clusterOutliers(visNetwork: string, options?: ClusterOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    findNode(visNetwork: string, nodeId: IdType): IdType[];
    /**
     ...
     * @memberOf NetworkService
     */
    getClusteredEdges(visNetwork: string, baseEdgeId: IdType): IdType[];
    /**
     ...
     *
     */
    getBaseEdge(visNetwork: string, clusteredEdgeId: IdType): IdType;
    /**
     ...
     *
     */
    updateEdge(visNetwork: string, startEdgeId: IdType, options?: EdgeOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    updateClusteredNode(visNetwork: string, clusteredNodeId: IdType, options?: NodeOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    getNodesInCluster(visNetwork: string, clusterNodeId: IdType): IdType[];
    /**
     ...
     * @memberOf NetworkService
     */
    openCluster(visNetwork: string, nodeId: IdType, options?: OpenClusterOptions): void;
    /**
     ...
     * @memberOf NetworkService
     */
    isCluster(visNetwork: string, nodeId: IdType): boolean;
    /**
     ...
     * @memberOf NetworkService
     */
    canvasToDOM(visNetwork: string, position: Position): Position;
    /**
     ...
     * @memberOf NetworkService
     */
    DOMtoCanvas(visNetwork: string, position: Position): Position;
    /**
     ...
     * @memberOf NetworkService
     */
    getNodeAt(visNetwork: string, position: Position): IdType;
    /**
     ...
     * @memberOf NetworkService
     */
    getEdgeAt(visNetwork: string, position: Position): IdType;
    /**
     ...
     * @memberOf NetworkService
     */
    getConnectedEdges(visNetwork: string, nodeId: IdType): IdType[];
    /**
     ...
     */
    getConnectedNodes(visNetwork: string, nodeOrEdgeId: IdType): IdType[] | {
        fromId: IdType;
        toId: IdType;
    }[];
    /**
     ...
     * @returns {{}}
     */
    getPositions(visNetwork: string, nodeIds: IdType[]): {
     ...
     * @param {string} visNetwork The network name/identifier.
     */
    getBoundingBox(visNetwork: string, nodeId: IdType): BoundingBox;
    /**
     * Returns the positions of the nodes.
     * @param {string} visNetwork The network name/identifier.
     */
    storePositions(visNetwork: string): void;
    /**
     ...
     */
    moveTo(visNetwork: string, moveToOptions: MoveToOptions): void;
    /**
