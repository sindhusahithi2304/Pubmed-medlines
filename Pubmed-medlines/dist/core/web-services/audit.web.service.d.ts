 ...
 */
export declare type AuditEvents = AuditEvent | AuditEvent[] | AuditRecord;
/**
 * The standard audit event types
 */
export declare const enum AuditEventType {
    None = "None",
 ...
 */
export declare class AuditWebService extends HttpService {
     ...
     */
    notifySponsoredLink(evt: AuditEventType, sl: LinkResult, resultId: string, parameters?: MapOf<string | number | boolean | undefined>): Observable<void>;
    /**
     ...
     */
    notifyDocument(evt: AuditEventType, doc: Record, resultsOrId: Results | string, parameters?: MapOf<string | number | boolean | undefined>, rfmParameters?: MapOf<string | number | boolean | undefined>): Observable<void>;
    /**
     * Notify the Sinequa server of a document event
     *
     * @param evt The audit event type
     ...
     * @param rfmParameters Additional RFM parameters
     */
    notifyDocumentById(evt: AuditEventType, id: string, parameters?: MapOf<string | number | boolean | undefined>, rfmParameters?: MapOf<string | number | boolean | undefined>): Observable<void>;
    /**
     * Notify logout
     */
    ...
    static ɵfac: i0.ɵɵFactoryDef<AuditWebService, never>;
    static ɵprov: i0.ɵɵInjectableDef<AuditWebService>;
}
//# sourceMappingURL=audit.web.service.d.ts.map