 ...
 */
export declare enum DidYouMeanKind {
    Original = 0,
    Corrected = 1
}
/**
 ...
 */
export declare type ListAggregationItem = AggregationItem;
/**
 ...
 */
export declare type ListAggregation = Aggregation;
/**
 * Describes the fields specific to a tree aggregation
 */
export declare type TreeAggregation = Aggregation;
/**
 ...
 */
export declare enum RFMDisplay {
    none = 0,
    positiveRate = 1,
    mainlyPosRate = 2,
    unrate = 4,
 ...
 */
export declare class QueryWebService extends HttpService {
     ...
     */
    getResults(query: IQuery, auditEvents?: AuditEvents, queryIntentData?: QueryIntentData): Observable<Results>;
    /**
     ...
     * @param auditEvents Any audit events to store on the server
     */
    getMultipleResults(queries: IQuery[], auditEvents?: AuditEvents): Observable<IMulti<Results>>;
    static ɵfac: i0.ɵɵFactoryDef<QueryWebService, never>;
    static ɵprov: i0.ɵɵInjectableDef<QueryWebService>;
}
//# sourceMappingURL=query.web.service.d.ts.map